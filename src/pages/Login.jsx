...
function Login() {
  ...
  async function handleSubmit(e) {
    ...
    try {
      ...
      const adminData = {
        adminid: res.data?.adminid || res.data?.admin?.id || null,
        adminname: res.data?.adminname || res.data?.admin?.name || null,
        adminemail: res.data?.adminemail || res.data?.admin?.email || null
      };
