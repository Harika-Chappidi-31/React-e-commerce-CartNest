        ...
        <div className="container">
          <div className="row align-items-center">
            ...
            <div className="col-lg-6">
              <h1 className="about-title">About CartNest</h1>

              <p className="about-text">
                CartNest is a modern eCommerce platform designed to make
        ...
        <div className="container">
          <div className="row">
            ...
            <div className="col-md-4 mb-4">
              ...
              <p>Email: support@CartNest.com</p>
          ...
          <div className="copyright">
            © 2026 CartNest. All Rights Reserved Codegnan Team.
          </div>
        </div>
      </footer>
